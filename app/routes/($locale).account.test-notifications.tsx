  ...
  return (
    ...
    >
      <div style={{maxWidth: '1000px', margin: '0 auto'}}>
        ...
        >
          <h1
            style={{margin: '0 0 20px 0', fontSize: '24px', color: '#234745'}}
          >
          ...
          >
            <div>
              ...
              <select
                value={stage}
                onChange={(e) =>
                  (window.location.href = `?stage=${e.target.value}&lang=${lang}`)
                }
                style={{
                  padding: '10px',
                  borderRadius: '8px',
            ...
            <div>
              ...
              <select
                value={lang}
                onChange={(e) =>
                  (window.location.href = `?stage=${stage}&lang=${e.target.value}`)
                }
                style={{
                  padding: '10px',
                  borderRadius: '8px',
        ...
        {activeTab === 'email' ? (
          ...
          >
            ...
            >
              ...
              ></div>
              <div
                style={{marginLeft: '20px', fontSize: '13px', color: '#666'}}
              >

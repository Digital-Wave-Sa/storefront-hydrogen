...
/**
 * The one way a points-redemption failure is shown.
 *
 * This message is rendered from two places — under the quick-redeem button and
 * under the custom-amount form — and they were styled separately, so restyling
 * one left the other shouting in bold centred red. Whichever of the two the
 * shopper happened to trigger decided which design they saw.
 *
 * Normal weight, start-aligned (so Arabic sits against the same edge as every
                ...
                {(fetcher: any) => {
                  ...
                  return (
                    <div className="w-full flex flex-col gap-1">
                      ...
                      <PointsRedemptionError message={actionError} />
                    </div>
                  );
                }}
              </CartForm>

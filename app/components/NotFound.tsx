  ...
  return (
    <div className="w-full flex flex-col items-center justify-center min-h-[80vh] px-4 py-12 bg-white" dir={isEn ? 'ltr' : 'rtl'}>
      ...
      <div className="text-center mb-8 flex flex-col items-center gap-2">
        <span className="text-gray-400 text-sm font-medium" style={{ fontFamily: "'GE Dinar One', sans-serif" }}>
          {isEn ? 'Error 404' : 'خطأ ٤٠٤'}
        </span>
        
        <h1 className="!text-[40px] md:!text-[50px] !font-bold text-[#1F413F] !leading-none mt-2 text-center" style={{ fontFamily: "'Bahij Janna', sans-serif" }}>
          {isEn ? 'It seems the page' : 'يبدو أن الصفحة'}
          <br />
          {isEn ? 'went eating sweets!' : 'ذهبت تتناول حلوى!'}
        </h1>
        
        <div className="text-gray-400 text-[15px] mt-4 flex flex-col gap-1" style={{ fontFamily: "'GE Dinar One', sans-serif" }}>
      ...
      <div className="w-full flex flex-col items-center">
        <span className="text-gray-400 text-sm mb-5" style={{ fontFamily: "'GE Dinar One', sans-serif" }}>

...
import { Form, Link, useActionData, useNavigation, useRouteLoaderData, useLoaderData, useLocation } from 'react-router';
...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-[#FDFBF7] flex items-center justify-center p-4 lg:p-8" dir={isEn ? 'ltr' : 'rtl'}>
      {/* Outer Flex Wrapper */}
      <div className={`w-full max-w-[1280px] mx-auto flex flex-col ${isEn ? 'lg:flex-row' : 'lg:flex-row-reverse'} gap-8 min-h-[640px]`}>

        ...
        <div className="otp-login-container">
            <div className="otp-login-card">
                <div className="otp-login-header">
                    ...
                    <p>{step === 'mobile' ? 'أدخل رقم جوالك لتصلك رسالة التحقق' : `أدخل الرمز المرسل إلى الرقم ${phoneNumber}+`}</p>
                </div>
                ...
                <p className="otp-footer">
                    بالاستمرار ، أنت توافق على <a href="/terms">الشروط والأحكام</a> و <a href="/privacy">سياسة الخصوصية</a>
                </p>
            </div>
        </div>
    );

    ...
    return (
        <section className={`w-full lg:py-24 bg-white ${isEn ? 'font-en' : 'font-ar'}`} dir={isEn ? 'ltr' : 'rtl'} style={{ paddingTop: '50px', paddingBottom: '50px' }}>
            <div className="max-w-[1400px] mx-auto">
                ...
                {/* Horizontal Slider */}
                <div className="flex gap-3 md:gap-4 lg:gap-6 overflow-x-auto hide-scrollbars snap-x snap-mandatory pb-4 lg:pb-10 px-6">
                    {recipients.map((recipient, index) => {
                        ...
                        return (
                            <Link
                                ...
                                className="group flex-shrink-0 w-[140px] md:w-[280px] lg:w-[320px] relative rounded-[12px] md:rounded-[32px] overflow-hidden snap-center transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl"
                            >

  ...
  const faqCategories = [
      ...
      items: [
        {
          question: isEn
            ...
            : 'كيف استخدم كود الخصم؟',
          answer: isEn
            ? "Enter the code in the 'Discount Code' field on the cart page or during checkout, then click 'Apply'. The amount will be deducted automatically from your total."
            : "أدخل الكود في حقل 'كود الخصم' في صفحة السلة أو في خطوة الدفع، ثم اضغط 'تطبيق'. سيخصم المبلغ تلقائياً من إجمالي طلبك. يمكن استخدام كود واحد فقط لكل طلب.",
        },
        {
          question: isEn
          ...
          answer: isEn
            ...
            : 'نقبل البطاقات الائتمانية، مدى، أبل باي، والدفع عند الاستلام.',
        },
        {
          question: isEn
            ? 'Can I modify the order after confirmation?'
            : 'هل يمكنني تعديل الطلب بعد تأكيده؟',
          answer: isEn
            ? 'Yes, you can contact customer service within 1 hour of placing the order to make changes.'
            : 'نعم، يمكنك التواصل مع خدمة العملاء خلال ساعة من تقديم الطلب لإجراء أي تعديلات.',
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          answer: isEn
            ? "You can track it in the 'Track Your Order' section."
            : "يمكنك تتبع طلبك في قسم 'تتبع طلبك'.",
        },
        {
          question: isEn
            ? 'What are the available delivery areas?'
            : 'ما هي مناطق التوصيل المتاحة؟',
          answer: isEn
            ? 'We deliver to most major cities in Saudi Arabia.'
            : 'نقوم بالتوصيل إلى معظم المدن الرئيسية في المملكة العربية السعودية.',
        },
        {
          question: isEn
    ...
    },
    {
      ...
      items: [
        {
          question: isEn
            ? 'How do I add a message to the gift?'
            : 'كيف أضيف رسالة للهدية؟',
          answer: isEn
            ? 'You can add a message in the gift options during checkout.'
            : 'يمكنك إضافة رسالة في خيارات الهدايا أثناء الدفع.',
        },
        {
          question: isEn
            ? 'Can I hide the price from the recipient?'
            : 'هل يمكن إخفاء السعر عن المستلم؟',
          answer: isEn
            ? "Yes, you can choose 'Send as gift' to hide the price."
            : "نعم، يمكنك اختيار 'إرسال كهدية' لإخفاء السعر.",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          answer: isEn
            ? 'Due to the nature of our products, returns are only accepted if damaged.'
            : 'نظراً لطبيعة منتجاتنا، فإننا نقبل الاسترجاع فقط إذا كان المنتج تالفاً.',
        },
      ],
    },
  ];
    ...
    >
      ...
      >
        ...
        <div className="relative max-w-[500px] w-full mt-2">
          <div className="relative flex items-center bg-white rounded-full overflow-hidden shadow-md">
            {/* Search Icon */}
            <div
              className={`absolute ${isEn ? 'left-5' : 'right-5'} text-gray-400`}
            >
              <svg
                width="18"
                height="18"
            ...
            {/* Search Button */}
            <button
              className={`absolute ${isEn ? 'right-1' : 'left-1'} h-[36px] px-8 bg-[#234745] hover:bg-[#1a3533] text-white rounded-full font-bold text-sm transition-colors`}
            >
              {isEn ? 'Search' : 'بحث'}
            </button>
          </div>
      ...
      <div className="max-w-[1280px] w-full mx-auto px-4 md:px-6 mt-10 md:mt-16 relative z-20 pb-20">
        ...
        {!searchQuery && !activeCategory && (
          <div className="bg-white rounded-2xl border border-[#234745]/10 shadow-sm p-8 mb-12 max-w-[800px] mx-auto">
            <h2
              className={`text-[26px] font-bold text-[#A07A58] flex items-center gap-2 ${isEn ? 'text-left' : 'text-right'}`}
              style={{
            ...
            <ul
              className="space-y-4 text-[#234745] text-[18px]"
              style={{
            ...
            >
              ...
              >
                ...
                <span>
                  {isEn ? 'How do I track my order?' : 'كيف اتتبع طلبي؟'}
                </span>
              </li>
              <li
                className="flex items-center gap-2 justify-start cursor-pointer hover:text-[#A07A58]"
        ...
        <div className="max-w-[800px] mx-auto space-y-10">
          {filteredCategories.length === 0 ? (
            <div className="text-center py-10">
              <p
                className="text-[20px] font-bold text-[#1F413F]"
                style={{
                  fontFamily: "'EnglishDigits', 'Bahij Janna', sans-serif",
                }}
              >
            ...
            filteredCategories.map((category, catIndex) => (
              <div key={category.title}>
                <h2
                  className={`text-[38px] font-bold text-[#234745] ${isEn ? 'text-left' : 'text-right'}`}
                  style={{
                    fontFamily: "'EnglishDigits', 'Bahij Janna', sans-serif",
                    lineHeight: '100%',
                    marginBottom: '32px',
      ...
      <div className="w-full bg-white py-16 mt-20 text-center">
        <div className="max-w-[800px] mx-auto px-4">
          <h2
            className="text-[50px] font-bold text-[#1a1a1a] mb-2"
            style={{
              fontFamily: "'EnglishDigits', 'Bahij Janna', sans-serif",
              lineHeight: '100%',
            }}
          ...
          <p
            className="text-[#9FB7AE] text-[18px]"
            style={{
              fontFamily: "'EnglishDigits', 'GE Dinar One', sans-serif",
              lineHeight: '100%',
              fontWeight: 500,

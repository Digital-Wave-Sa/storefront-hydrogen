...
export type BogoSuggestionGiftProductsQueryVariables = StorefrontAPI.Exact<{
  ids:
...
export type BogoSuggestionGiftProductsQuery = {
  nodes: Array<
    StorefrontAPI.Maybe<
      Pick<
...
export type SessionIdentityCustomerQuery = {
  customer?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Customer, 'id' | 'phone' | 'email'>
  >;
};
    ...
    nodes: Array<
      Pick<StorefrontAPI.Location, 'id' | 'name'> & {
        ...
        hide_from_storefront?: StorefrontAPI.Maybe<
          Pick<StorefrontAPI.Metafield, 'key' | 'value'>
        >;
        branch_id?: StorefrontAPI.Maybe<
          Pick<StorefrontAPI.Metafield, 'key' | 'value'>
        >;
        ax_store_id?: StorefrontAPI.Maybe<
          Pick<StorefrontAPI.Metafield, 'key' | 'value'>
        >;
...
export type GetCustomerAddressesForCheckoutQueryVariables =
  StorefrontAPI.Exact<{
    customerAccessToken: StorefrontAPI.Scalars['String']['input'];
  }>;

export type GetCustomerAddressesForCheckoutQuery = {
  customer?: StorefrontAPI.Maybe<{
    addresses: {
      nodes: Array<
        Pick<
...
export type GetLocationsBranchMetaQueryVariables = StorefrontAPI.Exact<{
  [key: string]: never;
}>;

export type GetLocationsBranchMetaQuery = {
  locations: {
    nodes: Array<
      Pick<StorefrontAPI.Location, 'id'> & {
        branch_id?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
      }
    >;
  };
};
...
export type ExportPageContentQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type ExportPageContentQuery = {
  exportHero: {
    nodes: Array<
      Pick<StorefrontAPI.Metaobject, 'id'> & {
        fields: Array<
...
> & {
  ...
  loyalty_points?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
...
export type ProductInfoPanelContentQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type ProductInfoPanelContentQuery = {
  productPanel: {
    nodes: Array<
      Pick<StorefrontAPI.Metaobject, 'id'> & {
        fields: Array<Pick<StorefrontAPI.MetaobjectField, 'key' | 'value'>>;
...
export type ProductQuery = {
  product?: StorefrontAPI.Maybe<
    ...
    > & {
      ...
      loyalty_points?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'value'>
      >;
      upsell_products?: StorefrontAPI.Maybe<{
        references?: StorefrontAPI.Maybe<{
...
export type ApiOfferProductsByIdQueryVariables = StorefrontAPI.Exact<{
  ids:
    | Array<StorefrontAPI.Scalars['ID']['input']>
    | StorefrontAPI.Scalars['ID']['input'];
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
...
export type ApiOfferProductsByIdQuery = {
  nodes: Array<
    StorefrontAPI.Maybe<
      Pick<
        StorefrontAPI.Product,
...
export type ApiOfferCollectionProductIdsQueryVariables = StorefrontAPI.Exact<{
  ids:
    | Array<StorefrontAPI.Scalars['ID']['input']>
    | StorefrontAPI.Scalars['ID']['input'];
}>;

export type ApiOfferCollectionProductIdsQuery = {
  nodes: Array<
    StorefrontAPI.Maybe<
      Pick<StorefrontAPI.Collection, 'id'> & {
        products: {nodes: Array<Pick<StorefrontAPI.Product, 'id'>>};
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query bogoSuggestionGiftProducts($ids: [ID!]!, $country: CountryCode, $language: LanguageCode) @inContext(country: $country, language: $language) {\n    nodes(ids: $ids) {\n      ... on Product {\n        id\n        handle\n        title\n        availableForSale\n        featuredImage {\n          url\n          altText\n        }\n        variants(first: 1) {\n          nodes {\n            id\n            availableForSale\n            price {\n              amount\n              currencyCode\n            }\n          }\n        }\n      }\n    }\n  }\n': {
    return: BogoSuggestionGiftProductsQuery;
    variables: BogoSuggestionGiftProductsQueryVariables;
  };
  ...
  '#graphql\n          query GetCustomerAddressesForCheckout($customerAccessToken: String!) {\n            customer(customerAccessToken: $customerAccessToken) {\n              addresses(first: 50) {\n                nodes {\n                  id\n                  firstName\n                  lastName\n                  address1\n                  address2\n                  city\n                  province\n                  zip\n                  country\n                  phone\n                }\n              }\n            }\n          }': {
    ...
    variables: GetCustomerAddressesForCheckoutQueryVariables;
  };
  ...
  '#graphql\n  query exportPageContent($country: CountryCode, $language: LanguageCode)\n    @inContext(country: $country, language: $language) {\n    exportHero: metaobjects(type: "export_hero", first: 1) {\n      nodes {\n        id\n        fields {\n          key\n          value\n          reference {\n            ... on MediaImage {\n              image { url }\n            }\n          }\n        }\n      }\n    }\n    exportWhy: metaobjects(type: "export_why", first: 1) {\n      nodes {\n        id\n        fields {\n          key\n          value\n          reference {\n            ... on MediaImage {\n              image { url }\n            }\n          }\n        }\n      }\n    }\n  }\n': {
    return: ExportPageContentQuery;
    variables: ExportPageContentQueryVariables;
  };
  ...
  '#graphql\n  query productInfoPanelContent($country: CountryCode, $language: LanguageCode)\n    @inContext(country: $country, language: $language) {\n    productPanel: metaobjects(type: "product_info_panel", first: 1) {\n      nodes {\n        id\n        fields {\n          key\n          value\n        }\n      }\n    }\n    giftCardPanel: metaobjects(type: "product_info_panel_giftcard", first: 1) {\n      nodes {\n        id\n        fields {\n          key\n          value\n        }\n      }\n    }\n  }\n': {
    return: ProductInfoPanelContentQuery;
    variables: ProductInfoPanelContentQueryVariables;
  };
  ...
  '#graphql\n  query apiOfferProductsById($ids: [ID!]!, $country: CountryCode, $language: LanguageCode) @inContext(country: $country, language: $language) {\n    nodes(ids: $ids) {\n      ... on Product {\n        id\n        handle\n        title\n        tags\n        availableForSale\n        featuredImage {\n          url\n          altText\n        }\n        priceRange {\n          minVariantPrice {\n            amount\n            currencyCode\n          }\n        }\n        compareAtPriceRange {\n          minVariantPrice {\n            amount\n            currencyCode\n          }\n        }\n        variants(first: 1) {\n          nodes {\n            id\n            availableForSale\n            price {\n              amount\n              currencyCode\n            }\n            compareAtPrice {\n              amount\n              currencyCode\n            }\n          }\n        }\n      }\n    }\n  }\n': {
    return: ApiOfferProductsByIdQuery;
    variables: ApiOfferProductsByIdQueryVariables;
  };
  '#graphql\n  query apiOfferCollectionProductIds($ids: [ID!]!) {\n    nodes(ids: $ids) {\n      ... on Collection {\n        id\n        products(first: 250) {\n          nodes {\n            id\n          }\n        }\n      }\n    }\n  }\n': {
    return: ApiOfferCollectionProductIdsQuery;
    variables: ApiOfferCollectionProductIdsQueryVariables;
  };

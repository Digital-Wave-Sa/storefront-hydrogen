...
export function DeliveryPickupModal({
    ...
    const overlay = (
        <div className="dpm-overlay" onClick={onClose} dir={isEn ? 'ltr' : 'rtl'}>
            ...
            >
                {/* Close button */}
                <button className="dpm-close" onClick={onClose} aria-label={isEn ? "Close" : "إغلاق"}>
                                    ...
                                    if (coords) {
                                        ...
                                        // Dynamic fee: disabled perKmRate as requested - always use base delivery fee
                                         ...
                                         /*
                                           ...
                                           is replaced at build time, so this whole
                                           branch is stripped from a production
                                           bundle rather than merely skipped.

                                           It has to be gated rather than kept,
                                           because the line prints the shopper's own
                                           city and street to the browser console —
                                           which is worth rather more than the usual
                                           stray debug message.
                                         */

...
export async function loader({request, params, context}: LoaderFunctionArgs) {
  ...
  const locationId =
    sessionLocationId || branchMap[branchName] || '114186715445'; // default to Olaya if unmapped
          ...
          >
            ...
            <div className="space-y-3">
              ...
              <p className="text-gray-500 text-xs font-medium leading-relaxed">
                {isEn
                  ? 'How would you rate the quality and taste?'
                  : 'ما هو تقييمك لجودة وطعم المنتج؟'}
              </p>
            ...
            <div className="pt-6 border-t border-[#EADFC9]/30 space-y-3">
              ...
              <div className="relative group">
                ...
                />
                <div
                  className={`w-full h-32 border-2 border-dashed ${selectedImage ? 'border-[#234745]' : 'border-[#EADFC9]'} rounded-2xl flex flex-col items-center justify-center gap-2 bg-[#FCFAF7] group-hover:bg-[#FCFAF7]/80 transition-all overflow-hidden`}
                >
                  {selectedImage ? (
                    <img
                      src={selectedImage}
                    ...
                    <>
                      ...
                      <p className="text-gray-400 font-bold text-xs">
                        {isEn ? 'Click to upload a photo' : 'اضغط لرفع صورة'}
                      </p>
                    </>
                  )}
                </div>
              ...
              {productRating === 0 && (
                <p className="text-center text-red-400 text-xs font-bold mt-3 animate-pulse">
                  {isEn
                    ...
                    : 'يرجى تقديم تقييم بالنجوم للمتابعة'}
                </p>
              )}
            </div>
          </fetcher.Form>

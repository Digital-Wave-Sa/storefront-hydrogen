      ...
      <div className="max-w-[1400px] mx-auto px-4 lg:px-6">
        ...
        <div className="hidden lg:grid grid-cols-[1fr_auto_1fr] items-center w-full">
          ...
          <div className="flex items-center gap-6 justify-end">
            ...
            {/* Loyalty Points */}
            <NavLink to={isEn ? "/en/account/wallet" : "/account/wallet"} className="flex group items-center gap-2 hover:opacity-70 transition-all !text-[#234745] text-[13px]" style={{ fontWeight: 500, fontFamily: '"GE Dinar One", sans-serif' }}>
            ...
            {/* Wishlist */}
            <NavLink to={isEn ? "/en/account/wishlist" : "/account/wishlist"} className="flex group items-center gap-2 hover:opacity-70 transition-all !text-[#234745] text-[13px]" style={{ fontWeight: 500, fontFamily: '"GE Dinar One", sans-serif' }}>
            ...
            {/* Cart */}
            <button onClick={() => open('cart')} aria-label="Cart" className="group flex items-center gap-2 hover:opacity-70 transition-all relative p-1 text-[#234745] text-[13px]" style={{ fontWeight: 500, fontFamily: '"GE Dinar One", sans-serif' }}>
              <div className="relative">

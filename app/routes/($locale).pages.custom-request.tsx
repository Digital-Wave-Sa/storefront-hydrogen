            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-6 text-start">
              ...
              <div className="pt-4 flex flex-col sm:flex-row items-center gap-4">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full sm:w-auto px-8 bg-[#25D366] text-white font-bold py-4 rounded-full text-[15px] flex items-center justify-center gap-2 hover:bg-[#20bd5a] transition-colors cursor-pointer"
                >
                  <span>💬</span>

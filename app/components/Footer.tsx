          ...
          return (
            <footer dir={isEn ? 'ltr' : 'rtl'} className={`w-full bg-[#234745] text-white flex flex-col items-center pt-12 pb-8 ${isEn ? 'font-en' : ''}`} style={isEn ? {} : { fontFamily: "'EnglishDigits', 'GE Dinar One', sans-serif" }}>
              <div className="w-full max-w-[1280px] flex flex-col gap-10 px-6 lg:px-12">
                ...
                {/* === MAIN 4 COLUMNS GRID === */}
                <div className="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 items-start border-b border-[#BBCFCD]/30 pb-12">

                  {/* Col 1 (Rightmost in RTL): Logo, Slogan, Socials, App Store Badges */}
                  <div className="flex flex-col items-start gap-4 text-start">
                    ...
                    <h3 className="font-bold text-[20px] lg:text-[22px] leading-tight text-white m-0">
                    ...
                    {/* App Buttons */}
                    <div className="flex flex-col gap-2.5 mt-2" dir="ltr">
                      <AppButtons />
                    </div>
                  </div>

...
export default function AboutPage() {
  ...
  const values = [
    {
      ...
      desc: isEn
        ? 'We choose the finest ingredients and refuse any compromise on quality whatever the cost.'
        : 'نختار أجود المكونات ونرفض أي تنازل في الجودة مهما كانت التكلفة',
    },
    {
      id: 2,
      title: isEn ? 'Authenticity & Heritage' : 'الأصالة والموروث',
      desc: isEn
        ? 'We preserve authentic recipes while embracing renewal that does not spoil the taste.'
        : 'نحافظ على الوصفات الأصيلة مع احتضان التجديد الذي لا يُفسد الطعم',
    },
    {
      id: 3,
      title: isEn ? 'Making People Happy' : 'إسعاد الناس',
      desc: isEn
        ? 'Every product we make aims to add a moment of joy and a beautiful memory.'
        : 'كل منتج نصنعه هدفه أن يضيف لحظة فرح وذكرى جميلة',
    },
    {
      id: 4,
    ...
    },
    {
      ...
      desc: isEn
        ? 'We support local communities and believe our success is not complete without the success of those around us.'
        : 'ندعم المجتمعات المحلية ونؤمن بأن نجاحنا لا يكتمل إلا بنجاح من حولنا',
    },
    {
      id: 6,
  ...
  const handleScroll = (direction: 'next' | 'prev') => {
    if (scrollRef.current) {
      ...
      const isRtl = !isEn;
      const multiplier =
        direction === 'next' ? (isRtl ? -1 : 1) : isRtl ? 1 : -1;
    ...
    >
      ...
      <div className="relative w-full bg-[#234745] overflow-hidden flex flex-col items-center justify-center text-white px-[20px] py-10">
        ...
        <div className="relative z-10 text-center max-w-[800px]">
          <p
            className="!text-[14px] md:!text-[16px] font-normal text-[#9FB7AE] mb-2"
            style={{
          ...
          >
            {isEn
              ? 'More than a century of authentic taste'
              : 'أكثر من مئة عام من الطعم الأصيل'}
          </h1>
          <p
            className="!text-[14px] md:!text-[16px] font-normal text-[#9FB7AE] mt-4"
            style={{
              fontFamily: "'EnglishDigits', 'GE Dinar One', sans-serif",
              lineHeight: '1.6',
            }}
          >
            {isEn
              ? 'A story that started with a stove and a secret recipe... and has become today part of the memory of every Saudi home.'
              : 'قصة بدأت بموقد ووصفة سرية، وأصبحت اليوم جزءاً من ذاكرة كل بيت سعودي'}
          </p>
        </div>
      </div>
        ...
        <div className="max-w-[1400px] mx-auto px-4 md:px-[80px] py-16 md:py-24">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-20 items-center">
            ...
            <div className="space-y-4 text-right order-2 md:order-1">
              ...
              <h2
                className="text-[26px] md:text-[44px] font-bold text-[#1F413F] !mt-1"
                style={{
                  fontFamily: "'EnglishDigits', 'Bahij Janna', sans-serif",
                  lineHeight: '1.2',
                }}
              >
                {isEn
                  ? 'It started with a man, a dream, and a small stove'
                  : 'بدأت برجل وحلم وموقد صغير'}
              </h2>
              <div
                className="text-[#7D7D7D] !font-normal !text-[16px] space-y-2 !mt-6"
                style={{
                  fontFamily: "'EnglishDigits', 'GE Dinar One', sans-serif",
                  lineHeight: '1.8',
                }}
      ...
      <div className="bg-[#fef8eb] pt-8 pb-2 md:py-12">
        <div className="max-w-[1400px] mx-auto px-4 md:px-[80px]">
          <div className="text-center mb-8">
            <p
              className="text-[#B5945B] text-[16px] font-bold mb-2"
              style={{
                fontFamily: "'EnglishDigits', 'GE Dinar One', sans-serif",
              }}
            >
            ...
            <h2
              className="text-[38px] font-bold text-[#1F413F]"
          ...
          <div
            className="relative w-full mx-auto block md:hidden"
            dir={isEn ? 'ltr' : 'rtl'}
          >
            {/* Scroll Container */}
            <div
            ...
            >
              {milestones.map((milestone) => (
                ...
                >
                  ...
                  >
                    <div
                      className="w-12 h-12 bg-[#234745] text-white rounded-full flex items-center justify-center text-xl font-bold"
                  ...
                  <div className="space-y-3">
                    <p
                      className="text-[#B5945B] text-[24px] font-bold"
                      style={{
                        fontFamily:
                    ...
                    <p
                      className="text-[#1F413F]/70 text-[14px] leading-relaxed min-h-[60px]"
                      style={{
                        fontFamily:
                          "'EnglishDigits', 'GE Dinar One', sans-serif",
                      }}
      ...
      <div className="bg-white py-16 md:py-24">
        <div className="max-w-[1400px] mx-auto px-4 md:px-[80px]">
          <div className="text-center mb-16">
            ...
            <h2
              className="text-[38px] font-bold !mb-0 text-[#1F413F]"
              style={{fontFamily: "'EnglishDigits', 'Bahij Janna', sans-serif"}}
            >
              {isEn
                ? 'What Guides Us in Every Decision'
                : 'ما يحكمنا في كل قرار'}
            </h2>
          </div>
          ...
          >
            {values.map((val) => (
              ...
              >
                <h3
                  className="text-[20px] md:text-[24px] font-bold text-[#1F413F]"
                  style={{
                    fontFamily: "'EnglishDigits', 'Bahij Janna', sans-serif",
                  }}
                >
                ...
                <p
                  className="text-[#9FB7AE] !text-[12px] md:!text-[16px] leading-relaxed"
                  style={{
                    fontFamily: "'EnglishDigits', 'GE Dinar One', sans-serif",
                  }}
                >
        ...
        <div className="max-w-[1400px] mx-auto px-4 md:px-[80px]">
          ...
          >
            ...
            <div className="flex flex-col gap-3 items-center justify-center space-y-2">
              ...
              >
                {isEn ? 'Years of Excellence' : 'عام من التميز'}
              </p>
            </div>
            ...
            <div className="flex flex-col gap-3 items-center justify-center space-y-2">
              ...
              >
                {isEn ? 'Branches in the Kingdom' : 'فرع في المملكة'}
              </p>
            </div>
...
function TimelineItem({number, year, title, desc, isEn}: any) {
  return (
    <div className="flex flex-col items-center text-center space-y-6">
      {/* The Box */}
      <div
        className="w-[120px] h-[120px] bg-[#EAF2F1] flex items-center justify-center"
        style={{borderRadius: isEn ? '32px 32px 0 32px' : '32px 32px 32px 0'}}
      >
        <div
          className="w-16 h-16 bg-[#234745] text-white rounded-full flex items-center justify-center text-2xl font-bold"
          style={{fontFamily: 'sans-serif'}}
        >
          {number}
        </div>
      ...
      <div className="space-y-2 max-w-[250px]">
        <p
          className="text-[#B5945B] text-[22px] font-bold"
        ...
        <p
          className="text-[#1F413F]/70 text-[14px]"
          style={{
            fontFamily: "'EnglishDigits', 'GE Dinar One', sans-serif",
            lineHeight: '1.6',
          }}
